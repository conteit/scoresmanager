...
public class TestExportToDoc implements IStorageListener{

	public static void main(String[] args) throws Exception{
		TestExportToDoc ts = new TestExportToDoc();
		...
		ExportToDoc.exportToFile(grest, "/Users/conteit/Desktop/storage.pdf", ts, ExportToDoc.PDF);
		ExportToDoc.exportToFile(grest, "/Users/conteit/Desktop/storage.html", ts, ExportToDoc.HTML);
	}
