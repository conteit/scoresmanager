...
public class Penality extends Score {

	public Penality(String desc, int teamCount) throws InconsistencyException {
		super(desc, teamCount);
	}

	public Penality(String desc, Integer[] values) throws InconsistencyException {
		super(desc, values);
	...
	public void sum(IScore s) throws InconsistencyException {
		for(int i=0; i<teamCount(); i++){
			if(getValue(i) > - s.getValue(i)){
				throw new InconsistencyException("Invalid argument (s.getValue(" + i + "): module is too big");
			}
		}
	}
	...
	public static IScore create(String desc, Integer[] values) throws InconsistencyException{
		return new Penality(desc, values);
	}
	...
	public static IScore create(String desc, int teamCount) throws InconsistencyException{
		return new Penality(desc, teamCount);
	}
}
