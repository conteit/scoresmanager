...
public class PasspartouPresDialog extends AbstractApplicationDialog {
	...
	public PasspartouPresDialog(){
		this(null, null);
	}
	
	public PasspartouPresDialog(Frame owner, IGrest g){
		super(owner);
		grest = g;
		setSize(575, 450);
		setResizable(false);
		...
		getContentPane().setLayout(new BorderLayout(0, 0));
		{
			...
			headerPane.setTitle("Passpartù Presentation Wizard");
			headerPane.setDescription("Configure settings to customize scores presentation");
			headerPane.setImage(new ImageIcon(PasspartouPresDialog.class.getResource("/it/conteit/scoresmanager/presentation/passpartou/Cregrest_BoxRight.gif")));
